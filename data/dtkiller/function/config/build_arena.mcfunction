...
scoreboard players operation #minx dtk.math < #x2 dtk.math
scoreboard players operation #dx dtk.math = #x1 dtk.math
scoreboard players operation #dx dtk.math > #x2 dtk.math
scoreboard players operation #dx dtk.math -= #minx dtk.math
...
scoreboard players operation #miny dtk.math < #y2 dtk.math
scoreboard players operation #dy dtk.math = #y1 dtk.math
scoreboard players operation #dy dtk.math > #y2 dtk.math
scoreboard players operation #dy dtk.math -= #miny dtk.math
...
scoreboard players operation #minz dtk.math < #z2 dtk.math
scoreboard players operation #dz dtk.math = #z1 dtk.math
scoreboard players operation #dz dtk.math > #z2 dtk.math
scoreboard players operation #dz dtk.math -= #minz dtk.math
